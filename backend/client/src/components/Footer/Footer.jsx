                ...
                <ul className="footer-contact-info">
                  <li>
                    ...
                    <a href="#" target="_blank">
                      1546 Kuala Lumpur, WA 89076
                    </a>
                  </li>
                  <li>
                    <span>Phone:</span>
                    <a href="tel:+601111233085">+60 1111 233085</a>
                  </li>
                  <li>
                    <span>Email:</span>
                    <a href="mailto:roninprogrammer@gmail.com">roninprogrammer@gmail.com</a>
                  </li>
                </ul>
      ...
      <div className="copyright-area">
        <div className="container">
          <div className="copyright-area-content">
            <p>
              Copyright @2024 AFC. All Rights Reserved by
